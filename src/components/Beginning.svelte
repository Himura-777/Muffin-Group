<section class="mt-[120px] mb-[80px]">
    <div class="mx-[9.01%]">
        <h2 class="font-[cormorant_garamond] text-center text-[#5e5e5e] text-4xl font-semibold">
            We have been<br>serving our dishes<br>since 1910
        </h2>
        <p class="mt-[20px] font-[poppins] text-[rgb(94, 94, 94)] text-[13px] text-center font-light">
